    ...
    <div class="home">
        ...
        <div class="home_slider_container">
            <div class="owl-carousel owl-theme home_slider">
                ...
                <!-- Slider Item -->
                <div class="owl-item">
                    <div class="home_slider_background" style="background-image:url(../assets/images/home_slider.jpg)">
                    </div>
                    ...
                    <div class="similar_posts_container">
                        ...
                        <div class="home_slider_next_container">
                            <div class="home_slider_next"
                                style="background-image:url('../assets/images/home_slider_next.jpg')">
            ...
            <div class="custom_nav_container home_slider_nav_container">
                <div class="custom_prev custom_prev_home_slider">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        x="0px" y="0px" width="7px" height="12px" viewBox="0 0 7 12" enable-background="new 0 0 7 12"
                        xml:space="preserve">
                            ...
                            <div class="section_content">
                                <div class="grid clearfix">
                                    ...
                                    <div class="card card_largest_with_image grid-item">
                                        <img class="card-img-top" src="../assets/images/post_1.jpg"
                                            alt="https://unsplash.com/@cjtagupa">
                                        <div class="card-body">
                                            <div class="card-title">
                                                <router-link @click.prevent="$scrollToTop" :to="{name: 'post'}"> How Did
                                                    van Gogh’s Turbulent
                                                    Mind Depict One of the Most Complex Concepts in Physics?
                                                </router-link>
                                            </div>
                                            <p class="card-text">Pick the yellow peach that looks like a sunset with
                                                its red, orange, and pink coat skin, peel it off with your teeth.
                                    ...
                                    <!-- Small Card With Image -->
                                    <div class="card card_small_with_image grid-item">
                                        <img class="card-img-top" src="../assets/images/post_3.jpg"
                                            ...
                                            <div class="playlist">
                                                ...
                                                <div class="video_container video_command active"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="video_image">
                                                            <div><img src="../assets/images/video_1.jpg" alt=""></div>
                                                            <img class="play_img" src="../assets/images/play.png"
                                                                alt="">
                                                        </div>
                                                        <div class="video_content">
                                                            <div class="video_title">How Did van Gogh’s Turbulent
                                                                Mind</div>
                                                ...
                                                <div class="video_container video_command"
                                                    ...
                                                    <div
                                                        class="video d-flex flex-row align-items-center justify-content-start">
                                                        <div class="video_image">
                                                            <div><img src="../assets/images/video_2.jpg" alt=""></div>
                                                            <img class="play_img" src="../assets/images/play.png"
                                                                alt="">
                                                        </div>
                                                        <div class="video_content">
                                                ...
                                                <div class="video_container video_command"
                                                    ...
                                                    <div
                                                        class="video d-flex flex-row align-items-center justify-content-start">
                                                        <div class="video_image">
                                                            <div><img src="../assets/images/video_3.jpg" alt=""></div>
                                                            <img class="play_img" src="../assets/images/play.png"
                                                                alt="">
                                                        </div>
                                                        <div class="video_content">
                                                ...
                                                <div class="video_container video_command"
                                                    ...
                                                    <div
                                                        class="video d-flex flex-row align-items-center justify-content-start">
                                                        <div class="video_image">
                                                            <div><img src="../assets/images/video_4.jpg" alt=""></div>
                                                            <img class="play_img" src="../assets/images/play.png"
                                                                alt="">
                                                        </div>
                                                        <div class="video_content">
...
import '../../public/assets/plugins/masonry/images_loaded'
